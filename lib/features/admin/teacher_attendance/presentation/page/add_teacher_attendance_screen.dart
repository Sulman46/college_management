                          ...
                          return _timeTableCubit.dataList.isNotEmpty && _teacherAttendanceCubit.teacherAttendanceModel.combinedPrograms!=null && _teacherAttendanceCubit.teacherAttendanceModel.combinedPrograms!.isNotEmpty
                            ...
                            menus: _timeTableCubit.dataList
                              ...
                              element.affiliation ==
                                  ...
                                  _teacherAttendanceCubit
                                      .teacherAttendanceModel
                                      .combinedPrograms!.contains(element.programName)
                            )
                                .map((e) => e.degree ?? "")
                                .toSet().toList(),
                            onSelected: (p0) {
                                  ...
                                  menus: _timeTableCubit.dataList
                                      ...
                                      element.affiliation ==
                                          ...
                                          _teacherAttendanceCubit
                                              .teacherAttendanceModel
                                              .combinedPrograms!.contains(element.programName)
                                          && element.degree==_teacherAttendanceCubit.teacherAttendanceModel.degree
                                  )
                                      .map((e) => e.section ?? "").toSet()
                                      .toList(),
                                  onSelected: (p0) {
                                    String val=_timeTableCubit.dataList
                                        .where(
                                  ...
                                  menus: _timeTableCubit.dataList
                                      ...
                                      element.affiliation ==
                                          ...
                                          _teacherAttendanceCubit
                                              ...
                                              .combinedPrograms!.contains(element.programName)
                                          && element.degree==_teacherAttendanceCubit.teacherAttendanceModel.degree
                                          && element.section==_teacherAttendanceCubit.teacherAttendanceModel.section
                                  )
                                      .map((e) => e.session ?? "").toSet()
                                      .toList(),
                                  onSelected: (p0) {
                                    String val=_timeTableCubit.dataList
                                        .where(
                          ...
                          return _timeTableCubit.dataList.isNotEmpty && _teacherAttendanceCubit.teacherAttendanceModel.session!=null
                            ...
                            menus: _timeTableCubit.dataList
                                ...
                                element.affiliation ==
                                    ...
                                    && element.degree==_teacherAttendanceCubit.teacherAttendanceModel.degree
                                    && element.section==_teacherAttendanceCubit.teacherAttendanceModel.section
                                    && element.session==_teacherAttendanceCubit.teacherAttendanceModel.session
                            )
                                .map((e) => "${e.semesterLevel ?? ""}").toSet()
                                .toList(),
                            onSelected: (p0) {
                              String val=_timeTableCubit.dataList
                                  .where(
                          ...
                          return _timeTableCubit.dataList.isNotEmpty && _teacherAttendanceCubit.teacherAttendanceModel.semesterLevel!=null
                            ...
                            menus: _timeTableCubit.dataList
                                ...
                                element.affiliation ==
                                    ...
                                    && element.section==_teacherAttendanceCubit.teacherAttendanceModel.section
                                    && element.session==_teacherAttendanceCubit.teacherAttendanceModel.session
                                    && element.semesterLevel.toString()==_teacherAttendanceCubit.teacherAttendanceModel.semesterLevel
                            )
