...
import 'add_teacher_attendance_screen.dart';


class GetSemesterTimetableSheetDialog extends StatefulWidget {
  const GetSemesterTimetableSheetDialog({super.key});

  @override
  State<GetSemesterTimetableSheetDialog> createState() =>
      _GetSemesterTimetableSheetDialogState();
}

class _GetSemesterTimetableSheetDialogState
    extends State<GetSemesterTimetableSheetDialog> {
                    ...
                    Expanded(
                      child: CustomElevatedButton(
                        ...
                        onPressed: () async {
                          ...
                          if(model.timetableId!=null && model.date!=null){
