...
class TeacherAttendanceTabButton extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: Row(
        children: [
          Expanded(child: _tabButton(text: "Live Dashboard", isSelected: true, onTap: () {},)),
          Expanded(child: _tabButton(text: "History", isSelected: false, onTap: () {},)),
        ],
      ),
    );
  }
