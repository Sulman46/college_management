          ...
          return Container(
            ...
            child: Column(
              ...
              children: [
                ...
                /// 🔹 ERROR TEXT
                AppText(
                  text: "Provide a unique identifier (e.g., CS, MATH, PHY)",
                  fontSize: 11,
                  color: AppColor.red,
                ),
                ...
                CustomTextFormField(
                  title: "OFFICIAL DEPARTMENT NAME :",
                ...
                CustomPopMenuButton(
                  ...
                  onSelected:  (p0) {
                    _departmentCubit.getStatus(['Active', 'Inactive'][p0]);

                  },
                  widget: DropDownFieldWidget(text: _departmentCubit.departmentStatus, isFilled: true),
                ),
                    ...
                    Expanded(
                      child: CustomElevatedButton(
                        onPressed: () async {
                          ...
                          if (widget.editDepartmentModel != null) {
                            var respo = await _departmentCubit.editDepartment(
                              model: RequestNewDepartmentModel(
                                name: nameController.text,
                                code: codeController.text,
                                status: _departmentCubit.departmentStatus,
                                id: widget.editDepartmentModel?.id ?? "",
                              ),
                            );
                            if (respo) {
                            ...
                            var respo = await _departmentCubit.addDepartment(
                              model: RequestNewDepartmentModel(
                                name: nameController.text,
                                code: codeController.text,
                                status: _departmentCubit.departmentStatus,
