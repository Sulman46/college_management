  ...
  void initState() {
    WidgetsBinding.instance.addPostFrameCallback((timeStamp) async{
      if(_studentRegisterCubit.updateStudentModel!=null){
        ...
        emailController.text=_studentRegisterCubit.updateStudentModel?.email??"";
      ...
      child: Scaffold(
        ...
        body: BlocBuilder(
          ...
          builder: (context, statenal) {
            return Column(
              children: [
                CustomTopBar(text:_studentRegisterCubit.updateStudentModel!=null? "Update Student":"Register Student"),
                          ...
                          children: [
                              ...
                              child: Column(
                                children: [
                                  ...
                                  CustomTextFormField(
                                    ...
                                    subTitle: "email..",
                                    readOnly:_studentRegisterCubit.updateStudentModel!=null ,
                                    title:_studentRegisterCubit.updateStudentModel!=null? "Email (read only)":"Email",
                                  ),
                                  SizedBox(height: 10),
                                  CustomTextFormField(
                                    isHintText: true,
                                    ...
                                    builder: (context,statebska) {
                                      return _semesterCubit.semesterList.isNotEmpty? CustomPopMenuButton(
                                        ...
                                        widget: DropDownFieldWidget(
                                          ...
                                          isFilled: _studentRegisterCubit.studentModel.affiliation!=null,
                                        ),
                                      ) :InkWell(
                                        onTap: () async{
                                         await _semesterCubit.getSemesterList();
                                    ...
                                    builder: (context,statebska) {
                                      return _semesterCubit.semesterList.isNotEmpty && _studentRegisterCubit.studentModel.affiliation!=null? CustomPopMenuButton(
                                        ...
                                        widget: DropDownFieldWidget(
                                          ...
                                          isFilled: _studentRegisterCubit.studentModel.department!=null,
                                        ),
                                      ) :InkWell(
                                        onTap: () async{
                                      ...
                                      builder: (context,statebska) {
                                        return _semesterCubit.semesterList.isNotEmpty && _studentRegisterCubit.studentModel.department!=null? CustomPopMenuButton(
                                          ...
                                          widget: DropDownFieldWidget(
                                            ...
                                            isFilled: _studentRegisterCubit.studentModel.programName!=null,
                                          ),
                                        ) :InkWell(
                                          onTap: () async{
                                      ...
                                      builder: (context,statebska) {
                                        return _semesterCubit.semesterList.isNotEmpty && _studentRegisterCubit.studentModel.programName!=null? CustomPopMenuButton(
                                          ...
                                          widget: DropDownFieldWidget(
                                            ...
                                            isFilled: _studentRegisterCubit.studentModel.degree!=null,
                                          ),
                                        ) :InkWell(
                                          onTap: () async{
                                      ...
                                      builder: (context,statebska) {
                                        return _semesterCubit.semesterList.isNotEmpty && _studentRegisterCubit.studentModel.degree!=null? CustomPopMenuButton(
                                          ...
                                          widget: DropDownFieldWidget(
                                            ...
                                            isFilled: _studentRegisterCubit.studentModel.section!=null,
                                          ),
                                        ) :InkWell(
                                          onTap: () async{
                                            if(_studentRegisterCubit.studentModel.programName!=null){
                                      ...
                                      builder: (context,statebska) {
                                        return _semesterCubit.semesterList.isNotEmpty && _studentRegisterCubit.studentModel.section!=null? CustomPopMenuButton(
                                          ...
                                          widget: DropDownFieldWidget(
                                            ...
                                            isFilled: _studentRegisterCubit.studentModel.session!=null,
                                          ),
                                        ) :InkWell(
                                          onTap: () async{
                                      ...
                                      builder: (context,statebska) {
                                        return _semesterCubit.semesterList.isNotEmpty && _studentRegisterCubit.studentModel.session!=null? CustomPopMenuButton(
                                          ...
                                          widget: DropDownFieldWidget(
                                            ...
                                            isFilled: _studentRegisterCubit.studentModel.semester!=null,
                                          ),
                                        ) :InkWell(
                                          onTap: () async{
                                  ...
                                  CustomPopMenuButton(
                                    ...
                                    widget: DropDownFieldWidget(
                                      ...
                                      isFilled: _studentRegisterCubit.status!=null,
                                    ),
                                  ),
                                  SizedBox(height: 10),
                                ],
                            ...
                            CustomElevatedButton(
                              onPressed: () async {
                                ...
                                model=model.copyWith(email: emailController.text,name: nameController.text,fatherName: fatherNameController.text,contact: contactNumberController.text,
